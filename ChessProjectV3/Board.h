...
#define CREATE_WHITE_SOLDIERS this->_board[7 - i / BOARD_SIZE][i % BOARD_SIZE] = new Pawns(WHITE, Point(i % BOARD_SIZE, 7 - i / BOARD_SIZE))
#define CREATE_BLACK_SOLDIERS this->_board[7 - i / BOARD_SIZE][i % BOARD_SIZE] = new Pawns(BLACK, Point(i % BOARD_SIZE, 7 - i / BOARD_SIZE))
